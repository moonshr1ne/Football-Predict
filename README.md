...
Голы: ожидание 3.14, ТБ2.5 60.7%, ТБ3.5 38.3%; чаще всего 3 (22.3%), 2 (21.4%), 4 (17.5%)
```
...
Отдельный блок `Голы` показывает ожидаемый тотал, вероятности ТБ2.5/ТБ3.5/ТБ4.5 и самые вероятные суммы голов в матче.
