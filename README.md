...
Точные счета выбираются гибридно: базовая сетка Пуассона по ожидаемым голам, затем поправка на реальные частоты счетов из истории обучения и на то, как часто команды играют на ноль или сами остаются без гола.
