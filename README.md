...
Локальное приложение для прогнозов матчей сборных на чемпионате мира: исход, ничья, “команда не проиграет”, три точных счета с вероятностью, вероятное количество голов с ТБ/ТМ, ожидаемый тотал угловых, последние 10 матчей обеих команд, сведения по сборным, травмы/мотивация/заметки, тактический профиль команд и проверка результата после матча с самообучением.
...
Точные счета выбираются гибридно: базовая сетка Пуассона по ожидаемым голам, затем усиленная поправка на реальные частоты счетов из истории обучения и на то, как часто команды играют на ноль или сами остаются без гола. Точные счета всегда согласованы с главным исходом: если выбран П1, все три счета будут в пользу первой команды; если X, все три будут ничейными. Для матчей с высокой вероятностью 4+ или 5+ голов модель добавляет верховой кандидат, а для явного фаворита сильнее поднимает счета 3-0/4-0 вместо автоматического ухода в 1-0.
