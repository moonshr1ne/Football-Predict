...
В `data/backtest.json` хранится строгий walk-forward baseline на матчах ЧМ-2026 и отдельный срез плей-офф. Все матчи одного дня прогнозируются до добавления результатов этого дня; счет, статистика, тактика и профили судей из будущего исключаются. Цели: 80% исходов, 20% точных счетов, MAE голов не больше 0.7, угловых не больше 1.5 и фолов не больше 2.0. Если цель не достигнута, интерфейс показывает фактическую цифру.
